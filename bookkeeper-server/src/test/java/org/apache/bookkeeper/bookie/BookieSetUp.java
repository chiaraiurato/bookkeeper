/*
 *  This class was originally present in Apache BookKeeper repository. It has been included in order to correctly instantiate a Bookie.
 */
 ...
 */
public class BookieSetUp extends BookieImpl {
    private static final Logger log = LoggerFactory.getLogger(BookieSetUp.class);

    private final Resources resources;

    public BookieSetUp(ServerConfiguration conf) throws Exception {
        this(new ResourceBuilder(conf).build());
    }

    public BookieSetUp(Resources resources, StatsLogger statsLogger) throws Exception {
    ...
    public BookieSetUp(Resources resources) throws Exception {
        super(resources.conf,
                resources.registrationManager,
                resources.storage,
                resources.diskChecker,
